---
title: "Distributions and assessing normality"
teaching: 80
exercises: 25
questions:
...
- "What is the normal distribution and what are its attributes?"
- "How can I tell if my data is normally distributed?"
- "What options do I have if my data is not normally distributed?"
objectives:
...
- "Assess whether a sample is normally distributed both visually and quantitatively."
...
- "Simple manipulations such as taking the logarithm or the square root of a sample can reversibly transform the observations into a more normal distribution."
source: Rmd
---

```{r, include = FALSE}
source("../bin/chunk-options.R")
knitr_fig_path("05-distributions-")
```
...
This process revolves around the data set resulting from your observation. To understand what you are formally doing when making and observation, we need to look at the structure of the phenotype that we are observing. 
