---
title: "Testing Rmd to md conversion and posting"
teaching: 45
exercises: 0
questions:
- "How to do I convert Rmd to md and post online?"
objectives:
- "Convert Rmd to md and post online."
keypoints:
- "Figure out MCB 585 lesson posting"
source: Rmd
output:
  md_document:
...
knitr_fig_path("17-testing-Rmd-to-md-")
```
