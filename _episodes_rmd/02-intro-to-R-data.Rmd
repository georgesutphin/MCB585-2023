...
[comma-separated values]({{ page.root }}/reference.html#comma-separated-values-csv) (CSV) format. 
Each row holds the observations for just one patient. Each column holds the inflammation measured 
in a day, so we have a set of values in successive days. 
...
```{r, eval = FALSE}
setwd("~/Desktop/r-novice-inflammation/") # MacOS
setwd("C:/User/<username>/Desktop/r-novice-inflammation/") # Windows --> replace <username> with your windows Username
```
