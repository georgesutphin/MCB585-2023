...
Note that the actual sections will not appear here after the code is converted to HTML for web publishing, but try pasting the above code into an RStudio script. You can also run a collapsed section of code by selecting the opening line and hitting <kbd>Ctrl</kbd>+<kbd>Enter</kbd>.
...
```{r}
weight_kg <- 55   # using <- sets the value of the variable 'weight_kg' to 55.
